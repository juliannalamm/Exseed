...
def create_tsne_trajectory_component():
    """Create the t-SNE trajectory viewer component with controls"""
    ...
    return html.Div(children=[
        html.Div(id="tsne-traj-meta", style={"marginBottom": "8px", "fontSize": "14px", "color": "white"}, children=default_meta),
        # view mode toggle
        html.Div([
            dcc.RadioItems(
                id="tsne-view-mode",
...
def register_tsne_trajectory_callbacks(app):
    ...
    @app.callback(
        ...
        Output("tsne-traj-meta", "children"),
        Input("tsne", "hoverData"),
        Input("tsne", "clickData"),
        Input("tsne-view-mode", "value"),
        prevent_initial_call=True,
    )
    def update_tsne_traj_view(hoverData, clickData, view_mode):
